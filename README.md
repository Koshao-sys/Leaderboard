...
**Leaderboard** is a list app using webpack and ES6 features built with HTML, CSS and JavaScript for showing the Name and scores from an API.
...
- [Live Demo Link](https://koshao-sys.github.io/Leaderboard/dist/)
...
Clone this repository to your desired folder: https://github.com/Koshao-sys/Leaderboard.git
...
You can deploy this project using: npm run start
